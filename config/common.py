...
PLATFORM_NAME = _('ШУТИС - Нээлттэй Боловсролын төв')
PLATFORM_DESCRIPTION = _('Open Education Center')
...
TIME_ZONE = 'Asia/Ulaanbaatar'  # http://en.wikipedia.org/wiki/List_of_tz_zones_by_name
LANGUAGE_CODE = 'mn'  # http://www.i18nguy.com/unicode/language-identifiers.html
